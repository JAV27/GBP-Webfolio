$(document).ready(function() {
    ...
    $('.read-more').on('click', function() {
        ...
        if(essay == 1) {
            ...
            $('.more-content h1').html('Term 4: Reflection--Personal and Skill Based');
            $('.paragraph-container p').html('Thinking back on The Greater Boston Project, one area which taking the class significantly improved is collaboration. In other classes, we of course have the occasional group project however it was never a core focus. In GBP however collaboration was of utmost importance. This was displayed in many ways throughout the year. One way which I found really interesting is the method of seating every day. Giving out cards to make sure our seating arrangement was different and unique every day was admittedly annoying a lot of the time. At the same time I understood the importance and objective of the exercise. It allowed us to learn how to communicate with people we weren’t always with. This was further emphasized in the post-project collaboration reflections. These forced us to reflect on how we worked with others, as well as what can be done better for the future. It also made it so that during projects you were actively aware of how your actions may be perceived by others since you know they will be reflected on later. These were helpful and led to discoveries on the difficulty of collaboration and how to do it best with others that are different from you that I would not have gained from other classes.Another aspect which was greatly improved through GBP is my presentation skills. Again in other classes we have occasional presentations but in no other class is the emphasis so heavily placed on the presentation abilities themselves. Being graded so heavily and specifically on this forced me to think about what I can do to improve for the next project. The videos also helped me grow a lot. I’ve always heard from other people that one of the best things to do to improve public speaking is to record yourself talking however I have never taken that initiative myself. Having a repository of my presentation videos to look at was eye opening because I could see all the little ticks and speech quirks I never noticed.');
        } else if(essay = 11) {
            $('.more-content h1').html('Term 4: Reflection--Content Based');
            $('.paragraph-container p').html('Taking such an in depth look into every part of Boston led to me changing a lot of my conceptions about Boston. One main one which was discussed a lot throughout the course is that the Northeast wasn’t necessarily much better than the South with regards to treatment of Blacks. We learned about Boston’s as well as other Northeastern city’s mistreatment of Blacks and the inequality they faced. I also learned about how heavily the immigrant populations shaped Boston. It seemed every event in Boston history owes itself to at least one immigrant group. Through both traditional class learning and interactive projects I also learned a lot about how change occurs and how much it takes for action to happen. We learned about women’s rights in Boston, African American rights, and large construction projects which all took years if not decades to go from start to end. No matter the kind of change, I learned that it takes lots of time, money, influence to get it done. I learned this through several of the projects we did as well. One that comes to mind is advertisement video project. For this project we had to set up a meeting to interview someone related to what we were advertising. Setting up these meetings and figuring out times and places to conduct them was difficult and showed me how hard it is to get through all the red tape that exists in the real world. ');
        }
        $('body').addClass('modal');
    });
